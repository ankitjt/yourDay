...
updateViewIcon.onclick = () =>
{
  ...
  completedTableView.classList.remove( "lg:table" )
  cancelledTableView.classList.remove( "lg:table" )
        ...
        let tableView = `
              <tr class="border-l-2 border-b-2 tableRow12 border-r-2 border-gray-200" data-id="${ doc.id
                      ...
                      <div class="appointmentStatus">
                        <div class="${ doc.data().appointmentStatus === 'Completed'
            ? 'block'
            : 'hidden'
          }">
            ...
            : doc.data().appointmentStatus
                        ...
                        <div class="${ doc.data().appointmentStatus === 'Cancelled'
            ? 'block'
            : 'hidden'
          }">
            ...
            : doc.data().appointmentStatus
                        ...
                        <div class="${ doc.data().appointmentStatus === 'Updated'
            ? 'block'
            : 'hidden'
          }">
            ...
            : doc.data().appointmentStatus
                        ...
                        <div class="${ doc.data().appointmentStatus === "Scheduled"
            ? 'block'
            : 'hidden'
          }">
                          <span>
    ...
    querySnapshot.forEach( ( doc ) =>
    {
        ...
        let tableView123 = `
          <tr class="border-l-2 border-b-2 tableRow12 border-r-2 border-gray-200" data-id="${ doc.id }">
           ...
           `
        completedTableViewRows.innerHTML += tableView123
