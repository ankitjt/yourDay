...
for ( let [ index, addMore ] of addMoreFields.entries() )
{
    addMore.onclick = () =>
    {
        ...
        let moreStartDate = `
         <input type="text" placeholder="Start Date" aria-autocomplete="none"
                            autocomplete="off" id="aptStartDate" title="${ fieldTags[ index ] } Appointment Start Date" onfocus="(this.type='date')"
