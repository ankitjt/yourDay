...
const forSecondOccurrenceType = () =>
{
  ...
  aptType.classList.add( '!bg-gray-400' )
  aptNature.classList.add( '!bg-gray-400' )
  aptName.classList.add( '!bg-gray-400' )
  aptEmail.classList.add( '!bg-gray-400' )
  aptMobileNumber.classList.add( '!bg-gray-400' )
  apt.pt_countryCode.classList.add( '!bg-gray-400' )
  apt.e_countryCode.classList.add( '!bg-gray-400' )
  aptFees.classList.add( '!bg-gray-400' )
  aptAddress.classList.add( '!bg-gray-400' )
  aptOccurrenceType.classList.add( '!bg-gray-400' )
  emergencyName.classList.add( '!bg-gray-400' )
  emergencyRelation.classList.add( '!bg-gray-400' )
  emergencyMobileNumber.classList.add( '!bg-gray-400' )
  emergencyAddress.classList.add( '!bg-gray-400' )
