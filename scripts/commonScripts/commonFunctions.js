...
// Loading Animation
let loadingAnimation = `<div class="loader absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 animate-pulse app-name w-fit text-white rounded-full px-5 py-8 bg-rose-400 text-md">
  yourDay
</div>`;
